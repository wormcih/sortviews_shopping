...
CREATE TABLE s_term_taxonomy (
	...
	taxonomy_description LONGTEXT NOT NULL DEFAULT '',
...
CREATE TABLE s_product_img (
	...
	img_type VARCHAR(32) NOT NULL DEFAULT 'picture',
...
INSERT INTO s_product_metadata VALUES(1, 1, 'feature_picture', 'test1.jpg');
